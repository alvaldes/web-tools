        ...
        <div className="flex">
          ...
          <div className="relative w-full">
            ...
            <button
              type="button"
              onClick={(e) => search(e)}
              className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white rounded-e-lg border border-blue-700 focus:ring-2 focus:outline-none bg-blue-600 hover:bg-blue-700 focus:ring-blue-800"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
